...
// valid UTF-8 string.
extern "C" enum YRX_RESULT yrx_rule_identifier(const struct YRX_RULE *rule,
                                    const uint8_t **ident,
                                    size_t *len);
...
extern "C" enum YRX_RESULT yrx_rule_namespace(const struct YRX_RULE *rule,
                                   const uint8_t **ns,
                                   size_t *len);
...
// [`yrx_rules_serialize`].
extern "C" enum YRX_RESULT yrx_rules_deserialize(const uint8_t *data,
                                      size_t len,
                                      struct YRX_RULES **rules);
...
extern "C" void yrx_rules_destroy(struct YRX_RULES *rules);
...
extern "C" enum YRX_RESULT yrx_scanner_create(const struct YRX_RULES *rules,
                                   struct YRX_SCANNER **scanner);

// Destroys a [`YRX_SCANNER`] object.
extern "C" void yrx_scanner_destroy(struct YRX_SCANNER *scanner);
...
extern "C" enum YRX_RESULT yrx_scanner_scan(struct YRX_SCANNER *scanner,
                                 const uint8_t *data,
                                 size_t len);
...
//
// See [`YRX_RULE_CALLBACK`] for more details.
extern "C" enum YRX_RESULT yrx_scanner_on_matching_rule(struct YRX_SCANNER *scanner,
                                             YRX_RULE_CALLBACK callback,
                                             void *user_data);
